...
public class ChatClient implements Runnable
{
	                  ...
	                  Logger parentLogger)
	{
		...
		/*
		 * DONE: Création de la socket vers host/port
		 */
		clientSocket = null;
		try
		{
		...
		{
			/*
			 * DONE Notez bien cette façon de faire, vous devrez la  reproduire
			 * par la suite
			 */
		...
		/*
		 * DONE Obtention du flux de sortie vers le serveur (serverOut) à partir
		 * de la clientSocket.
		...
		try
		{
			...
			// DONE Remove this line when serverOut is obtained
		}
		catch (IOException e)
		{
		...
		/*
		 * DONE Création PrintWriter temporaire sur le serverOut
		...
		if (serverOut != null)
		{
            ...
            serverOutPW = new PrintWriter(serverOut, true); //TRUE pour activer l'autoFlush
		...
		/*
		 * DONE Obtention du flux d'entrée depuis le serveur (serverIn) à partir
		 * de la clientSocket.
		 * Si une IOException
		...
		try
		{
			...
			// DONE Remove this line when serverIn is obtained
		}
		catch (IOException e)
		{
