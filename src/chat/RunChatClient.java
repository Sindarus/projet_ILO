...
public class RunChatClient extends AbstractRunChat
{
	...
	protected void launch()
	{
		...
		if (gui)
		{
			 ...
			 * TODO à customizer lorsque vous aurez créé la classe
			 * ClientFrame2
			 */
			...
			/*
			 * DONE Création du flux de sortie vers le GUI : userOut à partir du
			...
			/*
			 * DONE Création du flux d'entrée depuis le GUI : userIn à partir du
